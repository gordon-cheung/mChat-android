...
class SelectDeviceActivity : AppCompatActivity() {
    ...
    private var m_bluetoothAdapter: BluetoothAdapter? = null //lateinit is a variable you decalre but haven't initialized
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if(m_bluetoothAdapter == null) {
            toast("This device doesn't support Bluetooth") //This should never happen
            return
        }
